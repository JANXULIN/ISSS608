...
```
Convert X to Y, and add a linear regression. 
From this chart, we can see the positive between socioeconomic status and maths scores.
...
Convert X to Y, and add a linear regression. 
From this chart, we can see the positive between socioeconomic status and read scores.
...
Convert X to Y, and add a linear regression. 
From this chart, we can see the positive between socioeconomic status and science scores.
